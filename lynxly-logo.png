(function () {
  window.StudyUpSeed = {
    ...
    settings: {
      ...
      cardStyle: "stacked",
      dailyGoalMinutes: 5,
      preferredDailyAction: "smart",
      focusSize: "short",
      customDailyGoalMinutes: 5,
      dashboardVisibility: {
        streak: true,
        progress: true,
        aiCoach: true,
    ...
    onboarding: {
      ...
      valueMomentSeen: false,
      plusTrialOffered: false,
      plusTrialStartedAt: "",
      plusTrialEndsAt: "",
      plusTrialDismissedAt: "",
      completedAt: "",
      goal: "",
      topics: "",
      firstAction: "upload"
    ...
    schoolProfile: {
      ...
      schoolLevel: "gymi",
      schoolLevelLabel: "Gymnasium / Gymi",
      programme: "",
      mainGoal: "all",
      gradingSystem: "swiss_1_6",
      plusPointsEnabled: true,
      languageStyle: "de_ch",
      gradeDisplayMode: "average_pluspunkte",
